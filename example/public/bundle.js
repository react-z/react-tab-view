...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libMain = __webpack_require__(157);

	var _libMain2 = _interopRequireDefault(_libMain);

	var Tabs = _libMain2['default'].Tabs,
	    Tab = _libMain2['default'].Tab,
	    headers = ['heading 1', 'heading 2', 'heading 3'];

	var TabExample = _react2['default'].createClass({
	  displayName: 'TabExample',
	...
	_react2['default'].render(_react2['default'].createElement(TabExample, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		Tabs: __webpack_require__(158),
		Tab: __webpack_require__(159)
	};
	  ...
	  **/
	  ...
	  render: function render() {
	    ...
	    var headers = this.props.headers.map((function (h, i) {
	      return _react2["default"].createElement("li", { ref: "list" + i }, _react2["default"].createElement("a", { "data-tab-id": i, onClick: this.changeTab }, h));
	    }).bind(this));
